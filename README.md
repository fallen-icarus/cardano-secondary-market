...
#### The "Sale" Datum
One inline datum is used in the "Sale" UTxO to enforce the seller's terms. The datum is introduced here, and expanded upon in the Lifecycle section below.
...
[Swap-Market-Option Composition]()
...
### Bids
Bids are an essential feature for aftermarkets, especially for unique art or gaming NFTs. Future versions of Cardano-Secondary-Markets may enable a toggle-able "bid" feature, where bidders can send "Bid" UTxOs to the seller's address, leaving the final sale decision up to the seller.
